...
function SumUpSkill(skill, trainedonly, applyACP) {
    ...
    var ACP = "ACP";
    if (applyACP)
        SumUp(SkillTotal, [SkillRanks, SkillClassB, SkillIns, SkillAbility, SkillMisc, ACP])
    else
        SumUp(SkillTotal, [SkillRanks, SkillClassB, SkillIns, SkillAbility, SkillMisc])
...
function CalcAllSkills() {
    ...
    SumUp('TotalSkillSpent', ['AcrobaticsRanks', 'AthleticsRanks', 'BluffRanks', 'ComputersRanks', 'CultureRanks', 'DiplomacyRanks', 'DisguiseRanks', 'EngineeringRanks', 'IntimidateRanks', 'LifeSciRanks', 'MedicineRanks', 'MysticismRanks', 'PerceptionRanks', 'PhysSciRanks', 'PilotRanks', 'Profession1Ranks', 'Profession2Ranks', 'SenseRanks', 'SleightRanks', 'StealthRanks', 'SurvivalRanks'])
}
